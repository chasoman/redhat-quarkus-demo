...
> oc new-app --image-stream {Replace the image stream name in here after removing "image-registry.openshift-image-registry.svc:5000/" prefix } --name getting-started
